...
config.plugins.AC3LipSync.outerBounds = ConfigInteger(default = 80000, limits = (-80000,80000))
config.plugins.AC3LipSync.arrowStepSize = ConfigInteger(default = 5, limits = (-80000,80000))
config.plugins.AC3LipSync.activationDelay = ConfigInteger(default = 800, limits = (-80000,80000))
config.plugins.AC3LipSync.stepSize13 = ConfigInteger(default = 50, limits = (-80000,80000))
config.plugins.AC3LipSync.stepSize46 = ConfigInteger(default = 200, limits = (-80000,80000))
config.plugins.AC3LipSync.stepSize79 = ConfigInteger(default = 500, limits = (-80000,80000))
config.plugins.AC3LipSync.absoluteStep2 = ConfigInteger(default = 0, limits = (-80000,80000))
config.plugins.AC3LipSync.absoluteStep5 = ConfigInteger(default = 0, limits = (-80000,80000))
config.plugins.AC3LipSync.absoluteStep8 = ConfigInteger(default = 0, limits = (-80000,80000))
